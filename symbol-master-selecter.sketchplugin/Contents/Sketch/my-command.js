...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  if (selectedLayers.length == 1) {
    ...
    if (layer.symbolId == undefined) {
      sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("selected layer is not a symbol.");
    } else {
      gotoSymbolPage(doc);
      selectMaster(doc, layer.master); // zoom to artboard

      zoomToArtboard(doc, layer.master);
    }
  } else if (selectedLayers.length > 1) {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("multiple selection not supported.");
  } else {
...
function selectMaster(document, master) {
  ...
  document.selectedLayers.clear(); // get layers of master
